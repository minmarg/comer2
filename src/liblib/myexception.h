...
public:
    ...
    explicit myruntime_error( const mystring& arg, int ecl = NOCLASS ) throw();
    myruntime_error( const mystring& arg, 
    ...
    virtual mystring        pretty_format( mystring = mystring()) const throw();
...
inline myruntime_error::myruntime_error( const mystring& arg, int ecldesc ) throw()
:   myexception(),
    _errdsc( arg ),
    _class( ecldesc ),
    _file( NULL ),
...
inline myruntime_error::myruntime_error( const mystring& arg, 
