...
// -------------------------------------------------------------------------
// ExecDPUnroll32x: device code for executing dynamic programming using 
// shared memory and 32-fold unrolling along the diagonal of dimension 
// CUDP_2DCACHE_DIM;
