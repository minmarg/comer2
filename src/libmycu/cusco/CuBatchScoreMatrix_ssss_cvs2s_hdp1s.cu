...
// hdp1sTexo, texture object encapsulating HDP scores
// h1attr, serialized HDP scores
// hdp1swgt, weight of scoring HDP scores
...
// -------------------------------------------------------------------------
// CalcSM_SSSS_CVS2S_HDP1S_SMEMUnroll2x: device code for calculating 
// pairwise SS, context vector, and HDP scores at once;
